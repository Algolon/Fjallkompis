# Plan screen background (topographic contours)

`contours.svg` is the decorative background of the Plan home: a
single-colour topographic contour drawing (muted copper `#a1744c`, opacity
baked into the file) rendered over the pale warm sand base colour that lives
in CSS (`.screen-bg--plan`). Precached offline by the existing Workbox
`svg` glob.
...
- **Region:** z11 tile 1129/491 — approximately 67.942°N 18.457°E to
  67.876°N 18.633°E: the **Kebnekaise massif west flank above Láddjuvággi**.
